  ...
  return (
    <nav className='flex justify-between px-8 items-center h-18 bg-white shadow-md'>
      ...
      <div className='flex gap-4 justify-center items-center'>
        <Link className='text-white bg-linear-to-br from-purple-600 to-blue-500 hover:bg-linear-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-2xl rounded-base text-sm px-4 py-2.5 text-center leading-5' href="/login">Sign-in</Link>
      </div>
    </nav>
  )
}
